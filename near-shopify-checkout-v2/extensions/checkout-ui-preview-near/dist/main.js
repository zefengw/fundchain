      ...
      if (true) {
        module.exports = function $$$reconciler($$$hostConfig) {
          ...
          function scheduleUpdateOnFiber(fiber, lane, eventTime) {
            ...
            var priorityLevel = getCurrentPriorityLevel();
            if (lane === SyncLane) {
              if ((executionContext & LegacyUnbatchedContext) !== NoContext && (executionContext & (RenderContext2 | CommitContext)) === NoContext) {
...
For more info, visit https://reactjs.org/link/mock-scheduler`);
        ...
        for (i = 0; i < list.length; ++i) {
          ...
          if (isInstance(buf2, Uint8Array)) {
            if (pos + buf2.length > buffer.length) {
              Buffer3.from(buf2).copy(buffer, pos);
            } else {
  ...
  // extensions/checkout-ui-preview-near/src/index.jsx
  ...
  // node_modules/@shopify/checkout-ui-extensions/build/esm/components/Link/Link.mjs
  ...
  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/components/Link/Link.mjs
  ...
  var CheckoutUIExtensionError = /* @__PURE__ */ function(_Error) {
    _inherits(CheckoutUIExtensionError2, _Error);
    var _super = _createSuper(CheckoutUIExtensionError2);
    function CheckoutUIExtensionError2() {
      var _this;
      _classCallCheck(this, CheckoutUIExtensionError2);
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      _this = _super.call.apply(_super, [this].concat(args));
      _defineProperty(_assertThisInitialized(_this), "name", "CheckoutUIExtensionError");
      return _this;
    }
    return CheckoutUIExtensionError2;
  }(/* @__PURE__ */ _wrapNativeSuper(Error));
  var ScopeNotGrantedError = /* @__PURE__ */ function(_Error2) {
    _inherits(ScopeNotGrantedError2, _Error2);
    var _super2 = _createSuper(ScopeNotGrantedError2);
    function ScopeNotGrantedError2() {
      var _this2;
      _classCallCheck(this, ScopeNotGrantedError2);
      for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
        args[_key3] = arguments[_key3];
      }
      _this2 = _super2.call.apply(_super2, [this].concat(args));
      _defineProperty(_assertThisInitialized(_this2), "name", "ScopeNotGrantedError");
      return _this2;
    }
    return ScopeNotGrantedError2;
  }(/* @__PURE__ */ _wrapNativeSuper(Error));

  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/context.mjs
  var import_react9 = __toESM(require_react(), 1);
  var ExtensionApiContext = /* @__PURE__ */ (0, import_react9.createContext)(null);

  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/hooks/api.mjs
  function useExtensionApi() {
    var api = (0, import_react10.useContext)(ExtensionApiContext);
    if (api == null) {
  ...
  function useSubscription(subscription) {
    var _useState = (0, import_react11.useState)(subscription.current), _useState2 = _slicedToArray(_useState, 2), setValue = _useState2[1];
    (0, import_react11.useEffect)(function() {
      ...
      var unsubscribe = subscription.subscribe(checkForUpdates);
  ...
  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/hooks/shipping-address.mjs
  function useShippingAddress() {
    var shippingAddress = useExtensionApi().shippingAddress;
    if (!shippingAddress) {
  ...
  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/hooks/cost.mjs
  function useTotalAmount() {
    return useSubscription(useExtensionApi().cost.totalAmount);
  }

  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/hooks/cart-lines.mjs
  function useCartLines() {
    var _useExtensionApi = useExtensionApi(), lines = _useExtensionApi.lines;
    return useSubscription(lines);
  }

  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/hooks/translate.mjs
  var import_react12 = __toESM(require_react(), 1);
  function useTranslate() {
    var _useExtensionApi = useExtensionApi(), i18n = _useExtensionApi.i18n;
    var translate = (0, import_react12.useCallback)(function() {
  ...
  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/render.mjs
  var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
  function render2(extensionPoint, render3) {
    return extend(extensionPoint, function(root, api) {
      return new Promise(function(resolve, reject) {
        try {
          render(/* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ExtensionApiContext.Provider, {
            value: api,
            children: render3(api)
          }), root, function() {
            resolve();
          });
        } catch (error) {
  ...
  render2("Checkout::Actions::RenderBefore", () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(App, {}));
  function App() {
    const [total, setTotal] = (0, import_react14.useState)(0);
    const [totalInNear, setTotalInNear] = (0, import_react14.useState)(0);
    function sendRequest() {
      return __async(this, null, function* () {
        console.log("Button Pressed!");
        const response = yield fetch("https://www.thecocktaildb.com/api/json/v1/1/search.php?s=margarita%");
    ...
    function createByteString(s) {
      buf = import_buffer.Buffer.from(s).toString("base64");
      console.log(buf);
      return buf;
    }
    function createURL() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BlockStack2, {
      spacing: "loo",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Banner2, {
          title: "Fast Payments Powered by NEAR",
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link2, {
            to: createURL(),
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button2, {
              children: "Click here to use NEAR Wallet"
            })
          })
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Divider2, {}),
        console.log(amount),
